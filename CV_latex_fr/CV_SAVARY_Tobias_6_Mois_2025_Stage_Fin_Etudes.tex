    ...
    \begin{tcolorbox}
        ...
        \begin{minipage}{0.6\linewidth}
            \begin{center}
                ...
                \vspace*{0.5cm}
                \Large{\textcolor{white}{Recherche d'un stage de fin d'études 6 mois \\en tant qu'ingénieur en février 2025 dans le \\domaine de la donnée et de l'intelligence artificielle\\}}
                \vspace*{0.5cm}
